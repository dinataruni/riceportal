...
describe PurchasesController do
  ...
  let(:valid_attributes) { { "quote_id" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved purchase as @purchase" do
        ...
        post :create, {:purchase => { "quote_id" => "invalid value" }}, valid_session
        assigns(:purchase).should be_a_new(Purchase)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested purchase" do
        ...
        Purchase.any_instance.should_receive(:update).with({ "quote_id" => "1" })
        put :update, {:id => purchase.to_param, :purchase => { "quote_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the purchase as @purchase" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Purchase.any_instance.stub(:save).and_return(false)
        put :update, {:id => purchase.to_param, :purchase => { "quote_id" => "invalid value" }}, valid_session
        assigns(:purchase).should eq(purchase)
      end
